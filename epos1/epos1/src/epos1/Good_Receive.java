 ...
 * @author admin
 */
public class Good_Receive extends javax.swing.JFrame {

    /**
     * Creates new form Good_Receive
     */
    public Good_Receive() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Enter Code to Aquire Stock");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Good_Receive.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Good_Receive().setVisible(true);
            }
        });
    }
